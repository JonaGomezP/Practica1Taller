                    ...
                    <?php if ($res_admin != "0") : ?>
                        ...
                        <td>
                            <form action="borrarUsuario.php" method="POST">
                                ...
                                <input name="papelera" style="width: 35px; height:35px;" type="image" src="../IMG/papelera.png" alt="Eliminar usuario">
                            </form>
                        </td>
                    <?php endif; ?>
                <?php endforeach ?>
...
<?php if ($res_admin == 0) : ?>
    <h2 style="color: white;font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;">Nuevo vehículo</h>
        <div class="divFormulario">
                            ...
                            <?php if ($res_admin != "0") : ?>
                                ...
                                <td>
                                    <form action="datosUsuario.php" method="POST">
                                        ...
                                        <input type="hidden" name="pass" value="<?php echo $pass ?>">
                                        <input type="hidden" name="id_usuario" value="<?php echo $registro['id_usuario'] ?>">
                                        <input style="width: 35px; height:35px;" type="image" src="../IMG/papelera.png" alt="Eliminar usuario" name="basura">
                                    </form>
                                    <?php if (isset($_POST['basura_x'])) : ?>
                                        <?php require('borrarUsuario.php') ?>
                                    <?php endif; ?>
                                </td>
                            <?php endif; ?>
                        <?php endforeach ?>
