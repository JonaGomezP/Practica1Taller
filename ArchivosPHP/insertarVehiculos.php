...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertar = "INSERT INTO lista_vehiculos (id_usuario,marca,modelo,matricula,combustible,tipo_motor) VALUES ('$id_usuario','$marca','$modelo','$matricula','$combustible','$tipo_motor')";
